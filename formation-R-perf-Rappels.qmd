...
author: "SSP/DEMESIS"
description: |
  Support de formation R-perfectionnement : Module Rappels pour les utilisateurs de R au MASA
...
initiation** ou qui sont familiers des outils de manipulation de données (dplyr).\
...
{{< include 04_traitement-de-donnees.qmd >}}

{{< include 02_objets.qmd >}}

{{< include 03_indexation.qmd >}}
