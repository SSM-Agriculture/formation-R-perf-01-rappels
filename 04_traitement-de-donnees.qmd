...
|  |  |
|----|:---|
| ![](im%20g/clipboard-a%20ttention.png) | 2 packages à charger en début de programme |
...
|  |  |
|----|----|
| ! [ ](img/clipboard-pipe1.png) | ![](img/clipbo%20ard-pipe2.png){width="199"} |
...
+----------------------------------+----------------------------------+
| ![](                             | ![](i                            |
| im%20g/clipboard-pivotwider.png) | mg%20/clipboard-pivotlonger.png) |
+----------------------------------+----------------------------------+
| `m aTa ble %>% pivot_wid e r (   | `ma Table  %>%                   |
|  c o l_de_noms, col_de_valeurs)` |  pivot _long er(vari abl es_ a_p |
|                                  |  ivo ter , names_to = "ind i c a |
