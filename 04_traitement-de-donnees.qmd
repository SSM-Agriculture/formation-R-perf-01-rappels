...
+-----------------------------+-----------------------------+
| ![](im                      | ![](im%20%%202%20%7C%       |
| g/clipboard-pivotwider.png) | 20!%5B%5D(i%20m%20g%20%%202 |
|                             | %20%7C%200g/clipboard-pivot |
|                             | wider.png)%20%7C%200/clipbo |
|                             | ard-pivotlonger.png)![](img |
|                             | /clipboard-pivotlonger.png) |
+-----------------------------+-----------------------------+
| `                           | `maTable  %>%  p            |
| maTable %>% pivot_wider (co | ivot_longer( variables_apiv |
| l_de_noms, col_de_valeurs)` | oter , names_to = "indicate |
|                             | ur", values_to = "valeur")` |
+-----------------------------+-----------------------------+
| **col_de_noms** = nom de la | **variables_a_pivoter** =   |
| variable dont les modalités | nom de l'ensemble des       |
| deviendront les intitulés   | variables à représenter     |
| de colonne                  |                             |
|                             | **names_to** = nom de la    |
