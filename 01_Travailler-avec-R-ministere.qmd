...
-   Depuis la plate-forme **CERISE** :
    ...
    -   via le lien suivant : <https://rstudio.agriculture.rie.gouv.fr>

    <!-- -   via PISTACHE : Pistache \> Traitements statistiques et Diffusion \> R \> Migration SPSS et SAS vers R \> Accès au WIKI Cerise - R \> Accéder à Cerise -->
...
-   NB : existence d'une plate-forme CERISE de **Préproduction** :\
...
## Autres raccourcis claviers utiles :

-   Alt + - (moins ou tiret du 6) : flèche d'affectation '\<-'
-   Ctrl + I : bien indenter le code
-   Ctrl + Shift + A : pour reformater le code (passe à la ligne, ajoute des espaces...)
-   ​Ctrl + Alt + Shift + M : pour renommer en même temps plusieurs occurences du même terme
-   Ctrl + Shift + R : pour créer des sections
-    Alt + Shift + K : ouvrir l'aide sur les raccourcis claviers
