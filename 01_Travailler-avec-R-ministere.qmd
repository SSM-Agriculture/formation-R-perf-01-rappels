...
<!-- ## Présentation de R avec RStudio -->

<!-- <br> -->

<!-- **RStudio** = interface qu'on utilise au quotidien :  -->

<!-- -   permet le traitement de données et analyse statistique avec **R** ( = langage de programmation, ce qu'il y a sous le capot) : -->
...
<!-- | -   développement actif : communauté d’utilisateurs importante                 | -   pas de génération de code par « clic-bouton »                           | -->
...
<!-- | -   rapidité d'accès aux données (R travaille en mémoire)                      | -   documentation et aide souvent disponibles qu'en anglais                 | -->
