...
Les formations R perfectionnement s'adressent à des agents qui ont suivi (la formation R initiation)[https://ssm-agriculture.github.io/formation-R-initiation/] ou qui sont familiers des outils de manipulation de données (dplyr).\

## Avant-propos

Les formations R perfectionnement sont données en présentiel. Elles sont composées d'un socle commun **de 2 jours** et de modules optionnels **d'une journée**. 
...
[RStudio](https://posit.co/download/rstudio-desktop/) qui est mis à
